...
The BrainFoundry node contract (`docs/brainfoundry/NODE_CONTRACT.md`) and the BrainKernel governance model (the `nodeos` service) are versioned. Changes that break the wire protocol or command API require a version bump and a migration note.
